...
namespace sp {
    ...
    public:
        ...
        SimpleNeuralNetwork(
                ...
                std::vector<Matrix2D<float>> weightedMatrices,
                std::vector<Matrix2D<float>> valueMatrices,
                std::vector<Matrix2D<float>> biasMatrices,
                float learningRate = 0.1f)
                : _topology(topology),
                  _weightMatrices(weightedMatrices),
                  _valueMatrices(valueMatrices),
                  _biasMatrices(biasMatrices),
                  _learningRate(learningRate) {
            this->_topology = topology;
            this->_weightMatrices = weightedMatrices;
            this->_valueMatrices = valueMatrices;
            this->_biasMatrices = biasMatrices;
